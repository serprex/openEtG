...
def download(gid):
	return urlopen(Request("https://spreadsheets.google.com/feeds/download/spreadsheets/Export?key=0ArD2xZeFyBSAdE14M2d5NkhONGF2akdGUmhnQmJ1UWc#g&exportFormat=csv&gid=%i"%gid, headers={
