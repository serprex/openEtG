...
var data = {
	...
	aflatoxin:"Apply 2 poison to target. When target dies, it becomes a Malignant Cell",
	...
	boneyard:function(c){return "When a non-skeleton dies, summon a "+(c.upped?"2|2":"1|1")+" Skeleton"},
	...
	tidalhealing:"Remove poison & freezing from own creatures. Own aquatic creatures gain \"Apply 1 purify to owner on hit. Throttled\". Does not stack",
	...
	vend:"Sacrifice & draw",
	vengeance:"When ally a death occurs, during foe's turn, expend a stack & ally creatures attack",
	vindicate:"When ally a death occurs, it attacks again. Unready",
