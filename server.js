			...
			for (var i = 0;i < pack.amount;i++) {
				...
				if (data.element == 14){
					var newCardList = [
						...
						Cards.JackOLantern,Cards.EnergyAbsorber,Cards.GolemDefender,Cards.Shtriga, Cards.MidassTouch, Cards.Lemming, Cards.Georesonator, Cards.AtlantissProtection,
