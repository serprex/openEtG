...
exports.elementalshrine.info = { pos: [], text: ["'You walk up to the shrine. You don't know what to expect. Suddenly, you are attacked by a cloaked figure! Could it be the Shrine Guardian!?"] };
exports.aethertemple.info = { pos: [], text: ["As you approach the temple, you can feel the guardian waiting inside for you. This is it, another step on your quest to defeat the Temple Guardians."] }
exports.airtemple.info = { pos: [], text: ["As you approach the temple, you can feel the guardian waiting inside for you. This is it, another step on your quest to defeat the Temple Guardians."] }
exports.darktemple.info = { pos: [], text: ["As you approach the temple, you can feel the guardian waiting inside for you. This is it, another step on your quest to defeat the Temple Guardians."] }
exports.deathtemple.info = { pos: [], text: ["As you approach the temple, you can feel the guardian waiting inside for you. This is it, another step on your quest to defeat the Temple Guardians."] }
exports.aethertemple.info = { pos: [], text: ["As you approach the temple, you can feel the guardian waiting inside for you. This is it, another step on your quest to defeat the Temple Guardians."] }
exports.aethertemple.info = { pos: [], text: ["As you approach the temple, you can feel the guardian waiting inside for you. This is it, another step on your quest to defeat the Temple Guardians."] }
exports.aethertemple.info = { pos: [], text: ["As you approach the temple, you can feel the guardian waiting inside for you. This is it, another step on your quest to defeat the Temple Guardians."] }
exports.aethertemple.info = { pos: [], text: ["As you approach the temple, you can feel the guardian waiting inside for you. This is it, another step on your quest to defeat the Temple Guardians."] }
