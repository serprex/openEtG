...
impl Game {
	...
	pub fn get_foe(&self, id: i16) -> i16 {
		if id <= self.players_len() { self.plprops[self.props_idx(id)].foe } else { 0 }
	}

	pub fn get_weapon(&self, id: i16) -> i16 {
		if id <= self.players_len() { self.plprops[self.props_idx(id)].weapon } else { 0 }
	}

	pub fn get_shield(&self, id: i16) -> i16 {
		if id <= self.players_len() { self.plprops[self.props_idx(id)].shield } else { 0 }
	}
