...
for (const credit of [
	[
		...
		['Opening Music', 'sound/openingMusic.opus'],
	...
	[['Aves'], ['Aves Elemental', 'sound/avesElemental.opus']],
	...
	[
		...
		['Mulligan', 'sound/mulligan.opus'],
		['Click', 'sound/click.opus'],
		['creaPlay', 'sound/creaPlay.opus'],
		['permPlay', 'sound/permPlay.opus'],
		['Devour', 'sound/devour.opus'],
		['Dive', 'sound/dive.opus'],
		['Draw1', 'sound/draw1.opus'],
		['Draw2', 'sound/draw2.opus'],
		['Draw3', 'sound/draw3.opus'],
		['Draw4', 'sound/draw4.opus'],
		['Freeze', 'sound/freeze.opus'],
		['Lobotomize', 'sound/lobo.opus'],
		['Poison', 'sound/poison.opus'],
		['Shuffle', 'sound/shuffle.opus'],
		['Skelify', 'sound/skelify.opus'],
		['Stasis', 'sound/stasis.opus'],
		[],
	],
	[
