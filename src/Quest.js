...
exports.aethertemple = [
	{
		...
		dependency: requireQuest,
		questdependencies: [['elementalshrine', 1]],
	},
];
exports.airtemple = [
	{
...
//Menu info
exports.necromancer.info = {
	pos: [[200, 200], [200, 250], [225, 300]],
	text: [
...
exports.spirit.info = {
	pos: [[275, 350], [325, 375], [500, 200], [500, 250], [525, 275]],
	text: [
...
exports.blacksummoner.info = {
	pos: [[500, 420]],
	text: [
		'A swarm of dragons can be seen nearby. Maybe you could manage to tame one of them?',
	],
};
exports.icecave.info = {
	pos: [[300, 350], [260, 250], [220, 250], [200, 350]],
	text: [
...
exports.pgdragon.info = {
	pos: [[200, 200]],
	text: ['Fight the Dragon Tamer at the Proving Grounds!'],
};
exports.pgrare.info = {
	pos: [[250, 200]],
	text: ['Fight the Master of Arms at the Proving Grounds!'],
};
exports.pgshard.info = {
	pos: [[225, 250]],
	text: ['Fight the Gemcutter at the Proving Grounds!'],
};
exports.pgfarmer.info = {
	pos: [[175, 250]],
	text: ['Fight the Farmer at the Proving Grounds!'],
};
exports.pggeomancer.info = {
	pos: [[275, 250]],
	text: ['Fight the Geomancer at the Proving Grounds!'],
};
exports.pgnymph.info = {
	pos: [[225, 300]],
	text: ['Fight the Eunuch at the Proving Grounds!'],
};

exports.elementalshrine.info = {
	pos: [[400, 400]],
	text: [
