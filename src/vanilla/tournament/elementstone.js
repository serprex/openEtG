export default function (deck, mark) {
	...
	const rareCards = '4sj 4sk 4sl 4sm 4sn 4so 4sp 4sq 4sr 4ss 4st 4su 4vl 500 50a 52q 534 53e 55s 58v 59c 5c5 5cg 5cq 5f7 5fk 5fu 5io 5lh 5ls 5m6 5ol 5p0 5pa 5ro 5s4 5se 5ur 5v8 5vi 61u 62c 62m'.split(
		' ',
	);
	const usedCards = {};
	...
	for (let i = 0; i < deck.length; i++) {
		...
		if (
			bannedCards.some(ban => card.isOf(ban)) ||
